...
import 'package:clientdetails/clientdisplay.dart';
...
class _AddDetailsState extends State<AddDetails> {
  ...
  late TextEditingController _ctrl1 = new TextEditingController();
  late TextEditingController _ctrl2 = new TextEditingController();
  late TextEditingController _ctrl3 = new TextEditingController();
  late TextEditingController _ctrl4 = new TextEditingController();
        ...
        children: [
          ...
          ElevatedButton(onPressed: (){
            if(_formKey.currentState!.validate()){
                  setState(() {
                    _future = AddCategory(_ctrl.text, _ctrl1.text, _ctrl2.text,
                        _ctrl3.text, _ctrl4.text);
                  });
