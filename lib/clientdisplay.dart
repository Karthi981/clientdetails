...
import 'package:clientdetails/Constants.dart';
import 'package:clientdetails/clientadd.dart';
import 'package:flutter/material.dart';

import 'Models/Clientgetapi.dart';
    ...
    color: Colors.white,
      ...
      child: Column(
        children: [
          ...
          Padding(
            padding: const EdgeInsets.all(8.0),
            child: Text("Client Name: ${widget.clientName}",style: Nor18),
          ),
          Padding(
            padding: const EdgeInsets.all(8.0),
            child: Text("Client Id:  ${widget.clientId}",style: Nor18),
          ),
          Padding(
            padding: const EdgeInsets.all(8.0),
            child: Text("Phone number:${widget.phoneNumber}",style: Nor18),
          ),
          Padding(
            padding: const EdgeInsets.all(8.0),
            child: Text("Website: ${widget.website}",style: Nor18),
          ),
          Padding(
            padding: const EdgeInsets.all(8.0),
            child: Text("Email: ${widget.email}",style: Nor18),
          ),
          Padding(
            padding: const EdgeInsets.all(8.0),
            child: Text("Gst:  ${widget.gst}",style: Nor18,),
          ),
